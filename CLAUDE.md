...
The middle four (`ingest-source`, `critical-proposal-review`, `proposal-snapshot-diff`, `wiki-lint`) were drafted in subagent runs on 2026-05-24 and are not yet polished from practice. `fetch-literature` was drafted on 2026-05-25 from the worked precedent. Refine all in place as their workflows recur.
